...
const applyL1ToL2Alias = (address) => {
    ...
    return common_1.bnToAddress(ethers_1.ethers.BigNumber.from(address).add(exports.L1_TO_L2_ALIAS_OFFSET));
};
...
const undoL1ToL2Alias = (address) => {
    ...
    return common_1.bnToAddress(ethers_1.ethers.BigNumber.from(address).sub(exports.L1_TO_L2_ALIAS_OFFSET));
};
